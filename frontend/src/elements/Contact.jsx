...
import Breadcrumb from "../LMS/component/elements/common/Breadcrumb.jsx";
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="rn-page-title text-center pt--100">
                  ...
                  <p>
                    For any queries regarding the Platform, Subscription
                    Process, Account Registration, etc.{" "}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                <div className="rn-address">
                  ...
                  <div className="inner">
                    ...
                    <p>
                      <a href="tel:+057 254 365 456">+88 01913130113 </a>
                    </p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 col-12 mt_mobile--50">
                <div className="rn-address">
                  ...
                  <div className="inner">
                    ...
                    <p>
                      <a href="mailto:admin@gmail.com">info@methodmelody.com</a>
                    </p>
