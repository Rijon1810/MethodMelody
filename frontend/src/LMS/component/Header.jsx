...
const categoryList = [
    {
      primary: "Guitar",
      alt: "Guitar",
      src:"https://img.pngio.com/guitar-icon-png-268713-free-icons-library-guitar-icon-png-200_200.jpg",
    },
    {
    ...
    },
    {
      ...
      alt: "Piano/Keyboard",
      src:"https://lh3.googleusercontent.com/proxy/pxsl32UASnnENpKGiHho8ZWUhA-HWa06SYjdN9E_pxc24blCS4sDTxMECflBJ-ahVgCjkySVwlkI1CNsf54dUMSwW8i0UgzPppuE-gj7ZSdlHpTy5Rn4",
    },
    {
      primary: "Sound Engineering",
      alt: "Sound Engineering",
      src:"https://p7.hiclipart.com/preview/719/512/1002/recording-studio-audio-mixing-audio-mixers-audio-mastering-computer-icons-audio-mixer.jpg",
    },
  ];
...
class Header extends Component{
    ...
    render(){
        ...
        if(logo === 'light'){
            ...
            logoUrl = <img src="/assets/images/logo/lms-logo.png" alt="Digital Agency" />;
        }
                    ...
                    <div className="header-right">
                        <nav className="mainmenunav d-lg-block">
                            <ul className="mainmenu">
                                        ...
                                        {categoryList.map((category)=>(
                                             ...
                                             <Link to="/service">
                                                  ...
                                                  <Grid container direction="row" alignItems="center">
                                                      <Grid item style={{marginRight: 10}}> <Avatar alt={category.alt} src={category.src} /></Grid>
                                ...
                                <li className="has-droupdown"><Link to="/service">Musicians</Link>
                                    <ul className="submenu" style={mystyle}>
                                        {this.state.instructorList.map((instructor)=>(
                                           <li>
                                               <Link to="/service">
                                               <Grid container direction="row" alignItems="center">
                                                   <Grid item style={{marginRight: 10}}> <Avatar alt={instructor.name} src={"http://162.0.231.67/"+ instructor.photo}/></Grid>
                                ...
                                <li className="has-droupdown"><Link to="#pages" >Cart</Link></li>
