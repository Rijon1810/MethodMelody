                            ...
                            {this.state.courseList.map((course) => (
                                <div className="portfolio" key={course._id}>
                                    <div className="thumbnail-inner">
                                        ...
                                        <img src={"http://162.0.231.67/"+course.thumbnail} width="100%"/>
                                    </div>
                                    <div className="content">
                                        <div className="inner">
                                            <h5>{course.catagory+" course"}</h5>
                                            <h4><a href="/portfolio-details">{course.title}</a></h4>
                                            <div className="portfolio-button">
                                                <a className="rn-btn" href="/portfolio-details">View more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
